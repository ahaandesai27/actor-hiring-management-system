...
const LandingPage = () => {
  return (
    <div className="bg-black text-gray-100">
      <nav className="container bg-red-600 mx-auto flex justify-between items-center py-4 px-6" style={{
    backgroundColor: "rgba(255, 200, 0, 0.29)"}}>
        ...
        <div className="hidden md:flex space-x-8">
            <a href="#features" className="text-white hover:text-yellow-300">Features</a>
            <a href="#how-it-works" className="text-white hover:text-yellow-300">How It Works</a>
            <a href="#testimonials" className="text-white hover:text-yellow-300">Testimonials</a>
        </div>
      ...
      <div className="max-w-3xl w-full text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Building digital networks for <p className='text-red-600'>film professionals.</p>
        </h1>
        <p className="text-xl text-gray-300 mb-8">
          The complete platform for connecting, hiring, and managing talent across the film industry, helping you build exceptional productions and creative teams.
        </p>
    ...
    backgroundColor: "rgba(250, 201, 24, 0.16)", // Goldish with transparency
            ...
            <p className="text-gray-300">
              Create detailed portfolios showcasing your work history, skills, and expertise in the film industry.
            </p>
          </div>
          
          <div className="p-6 rounded-lg border border-yellow-300" style={{
    padding: "1.5rem",
    borderRadius: "0.5rem",
    border: "2px solid #FFD700",
    backgroundColor: "rgba(250, 201, 24, 0.16)", // Goldish with transparency
            ...
            <p className="text-gray-300">
              Post and find opportunities for every sector of film production, from pre-production to post.
            </p>
          </div>
    ...
    backgroundColor: "rgba(250, 201, 24, 0.16)", // Goldish with transparency
            ...
            <h3 className="text-xl font-bold mb-3">Location Booking</h3>
            <p className="text-gray-300">
              Discover and book scenic filming locations with detailed information and availability calendars.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 border-y border-yellow-300 shadow-[0px_0px_8px_#FFD700]">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-8">Ready to transform your film hiring process?</h2>
          <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
            Join thousands of film professionals already using ProdCast to hire exceptional professionals.
          </p>
      ...
      {/* Footer */}
      <footer className="bg-gray-900 py-12 border-t border-gray-800" style={{
    backgroundColor: "rgba(255, 200, 0, 0.29)", 
  }}>
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-400 max-w-xs">
                Connecting film professionals with the perfect projects and teams since 2025.
              </p>
            </div>
